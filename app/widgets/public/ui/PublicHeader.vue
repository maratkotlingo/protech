<template>
  <header class="sticky top-0 z-40 px-3 py-3 sm:px-4">
    <div class="mx-auto w-full max-w-370">
      <div class="relative flex min-h-18 items-center gap-3 rounded-[2rem] bg-white/90 p-2 shadow-[0_18px_70px_rgba(15,23,42,0.08)] backdrop-blur-2xl  ">
        <NuxtLink
          to="/"
        ...
        <nav class="absolute left-1/2 top-1/2 hidden -translate-x-1/2 -translate-y-1/2 items-center gap-1 rounded-full bg-[#f3f4f6] p-1 xl:flex ">
          <NuxtLink
        ...
        <div class="ml-auto flex items-center gap-1 sm:gap-2">
          ...
          >
            <span
              v-if="messageNotifications.unreadCount"
    ...
    >
      ...
      >
        ...
        <aside class="absolute inset-y-3 right-3 flex w-[min(390px,calc(100vw-1.5rem))] flex-col rounded-[2rem] bg-white p-4 shadow-2xl shadow-zinc-950/25 ">
          ...
          >
            <NuxtLink
              ...
              :class="isNavActive(item) ? 'text-emerald-700' : ''"
              @click="closeMobileMenu"
            >
          ...
          <div class="mt-auto space-y-3 pt-6">
            <div
              v-if="auth.user"
              class="rounded-[1.75rem] bg-[#f9fafb] p-4 "
            >
